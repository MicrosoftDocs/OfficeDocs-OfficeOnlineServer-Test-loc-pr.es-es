...
Antes de iniciar los procedimientos siguientes, realice los pasos de los temas sobre cómo [Deploy a single-server Office Web Apps Server farm that uses HTTPS](\deploy-office-web-apps-server#deploy-a-single-server-office-web-apps-server-farm-that-uses-https) o sobre cómo [Deploy a multi-server, load-balanced Office Web Apps Server farm that uses HTTPS](deploy-office-web-apps-server#deploy-a-multi-server-load-balanced-office-web-apps-server-farm-that-uses-https) para comprobar que ha configurado Office Web Apps Server.
