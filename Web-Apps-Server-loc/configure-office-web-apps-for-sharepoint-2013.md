...
Antes de iniciar los procedimientos siguientes, realice los pasos de los temas sobre cómo [Deploy a single-server Office Web Apps Server farm that uses HTTPS](deploy-office-web-apps-server#implementar-una-granja-de-un-solo-servidor-de-office-web-apps-server-que-usa-https) o sobre cómo [Deploy a multi-server, load-balanced Office Web Apps Server farm that uses HTTPS](deploy-office-web-apps-server#implementar-una-granja-de-varios-servidores-y-de-carga-equilibrada-de-office-web-apps-server-que-usa-https) para comprobar que ha configurado Office Web Apps Server.
