---
title: 'Implementar la infraestructura: Office Web Apps Server'
TOCTitle: 'Implementar la infraestructura: Office Web Apps Server'
ms:assetid: ec93a103-8072-435f-9e80-897c0aa7b914
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ219458(v=office.15)
ms:contentKeyID: 48793549
ms.date: 01/04/2018
mtps_version: v=office.15
ms.translationtype: HT
---

# Implementar la infraestructura: Office Web Apps Server
...
Office Web Apps Server es un nuevo producto de servidor de Office que proporciona las versiones de explorador de Word, PowerPoint, Excel y OneNote. Una única granja de Office Web Apps Server puede admitir usuarios que tienen acceso a los archivos de Office desde SharePoint 2013, Lync Server 2013, Exchange Server 2013, carpetas compartidas y sitios web. El nuevo modelo de implementación autónomo significa que puede administrar actualizaciones en la granja de Office Web Apps Server con independencia de otros productos de servidor de Office implementados en su organización.

![Logotipo de Office 2013](images/JJ219458.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Logotipo de Office 2013")Los artículos de la tabla siguiente están destinados a los profesionales de TI que planean configurar Office Web Apps Server localmente en su organización.

### Artículos de Office Web Apps Server en TechNet
...
<tbody>
<tr class="odd">
<td><p><a href="office-web-apps-server-overview.md">Introducción a Office Web Apps Server</a></p></td>
<td><p>Obtenga información sobre la forma en que Office Web Apps Server ofrece funciones de Office de explorador a los hosts locales de su organización.</p></td>
</tr>
<tr class="even">
<td><p><a href="plan-office-web-apps-server.md">Planear Office Web Apps Server</a></p></td>
<td><p>Obtenga información sobre los requisitos de Office Web Apps Server, como HTTPS, certificados, virtualización, equilibrio de cargas, topologías y seguridad.</p></td>
</tr>
<tr class="odd">
<td><p><a href="deploy-office-web-apps-server.md">Implementar Office Web Apps Server</a></p></td>
<td><p>Obtenga información sobre cómo implementar Office Web Apps Server localmente.</p></td>
</tr>
<tr class="even">
<td><p><a href="technical-reference-for-office-web-apps-server.md">Referencia técnica para Office Web Apps Server</a></p></td>
<td><p>Encuentre artículos de referencia técnica para Office Web Apps Server. Incluyen ayuda para los cmdlets de Windows PowerShell para OfficeWebApps.</p></td>
</tr>
</tbody>
</table>
